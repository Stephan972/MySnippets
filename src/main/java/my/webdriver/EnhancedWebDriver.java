...
public class EnhancedWebDriver implements WebDriver, JavascriptExecutor, TakesScreenshot {
    ...
    /**
     * 
     * The current thread sleeps until the given {@code expectedCondition} is met.
     * 
     * @param expectedCondition
     * @return A value of type defined by the {@code expectedCondition} or null if
     *         timeout expires.
    ...
    /**
     * 
     * Get the given {@code url} with ajax hook enabled. Calling this method is
     * equivalent to:
     * <p>
     * {@code get(url, true)}
     * </p>
    ...
    /**
     * 
     * NOTA: The javascript injection may slow down the calling java code. Enable
     * ajax hook only if necessary.
     * 
     * @param url
    ...
    /**
     * 
     * Install a javascript hook that dump responses of any XHR call matching the
     * HTTP method ({@code method}) and the given url ({@code url}).
     * 
     * @param method
     ...
     * @see #waitUntilAjaxRequestIsCompleted(String)
     * 
     */
     ...
     *
     * @see #startMonitoringAjaxRequest(String, String)
     * @see #stopMonitoringAjaxRequest(String)
     *
     */
    ...
    /**
     * 
     * Look for HTTP response received for {@code originalUrl} in the performance
     * logs.
     * 
     * @param url
     * @return
            ...
            while (!rawHttpResponseFound && (attempts > 0)) {
                ...
                if (currentEntryMessage != null) {
                    ...
                    case FIND_REQUEST_ID:
                        if (currentEntryMessage.contains("\"method\":\"Network.requestWillBeSent\"") && currentEntryMessage.contains("\"url\":\"" + url.toLowerCase())) {
                    ...
                    case FIND_RESPONSE:
                        if (currentEntryMessage.contains("\"method\":\"Network.responseReceived\"") && currentEntryMessage.contains("\"requestId\":\"" + requestId + "\"")) {
    ...
    private class NetworkSniffer extends WebSocketClient {
        ...
        /**
         * 
         * Returns a message sent by Chrome. The method waits no longer than 5 seconds.
         * It returns null if the timeout elapses.
         * 
         * @return The next available message or null if this message fails to arrive
         *         within 5 seconds.
         */
