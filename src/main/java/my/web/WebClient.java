...
public class WebClient {
        ...
        try {
            ...
            try {
                ...
                r = Jsoup.connect(url) //
                        ...
                        .sslSocketFactory(configuration.validateTLSCertificates() ? null : acceptAnyCertificatesSslSocketFactory()) //
                        .method(method) //
                        .data(data) //
     ...
     * @return
     * 
     * @see https://stackoverflow.com/a/55531011/363573
     * 
     */
    private SSLSocketFactory acceptAnyCertificatesSslSocketFactory() {
